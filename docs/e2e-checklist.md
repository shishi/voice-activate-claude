...
- [ ] Code/Cowork の状態から vac.check inject → Homeに戻り、チャットモードに切替、新規チャットが開いて送信される
- [ ] 「新しいタスク」には絶対に送られない(Cowork選択中でも必ずチャットの新規チャットになる)
- [ ] 送信のたびに新規チャットが開かれ、まっさらな会話に送られる
- [ ] 前回の未送信テキストが入力欄に残っていても、新しい発話だけが送られる(貼り付け前にクリアされる)
- [ ] 送信先が必ずチャットモードの入力欄であること(Cowork/Codeには入らない)
